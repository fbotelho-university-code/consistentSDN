...
%%%%%%% PERSONAL COMMANDS %%%%%%%%%%%
\newcommand{\distcontrollers}{\cite{:vn, Tootoonchian:2010vy,Koponen:2010th,Yeganeh:2012jm,jain2013b4}}
...
\epigraph{The nice thing about standards is that you have so many to choose from.}{Andrew S. Tanenbaum} 
...
\endgroup
\LIMPA
\chapter{Architecture\includegraphics[]{PEI.pdf}
}\label{chapter:3}
